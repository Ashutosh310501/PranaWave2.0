...
app.use(express.static('../CalorieCalculator'));
// app.use(express.static('public'));
...
app.post('/yoga', async (req, res) => {
  ...
  try {
    ...
    if (password === cpassword) {
      ...
      // res.send(postData)-->shows json for entered data in registration form
      res.send("User Created ! Now Login");
